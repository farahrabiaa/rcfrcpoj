/*
  # Link Wholesale Customers to Wholesale Table

  1. New Tables
    - `customer_wholesale_tiers` - Junction table to link customers with wholesale tiers
      - `customer_id` (uuid, references customers.id)
      - `tier_id` (uuid, references wholesale_tiers.id)
  ...
  2. Changes
    - Add function to get wholesale customers with their tier information
...
-- Create policies
CREATE POLICY "Admins can manage customer wholesale tiers"
