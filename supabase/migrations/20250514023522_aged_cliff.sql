...
-- Drop existing trigger first to break the dependency
...
DROP FUNCTION IF EXISTS get_ratings_by_type(TEXT, UUID) CASCADE;
DROP FUNCTION IF EXISTS get_ratings_stats(TEXT, UUID) CASCADE;
DROP FUNCTION IF EXISTS get_ratings_report(TEXT, INTEGER) CASCADE;
