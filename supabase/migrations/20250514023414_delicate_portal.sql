...
DROP FUNCTION IF EXISTS get_ratings_by_type(TEXT, UUID);
DROP FUNCTION IF EXISTS get_ratings_stats(TEXT, UUID);
DROP FUNCTION IF EXISTS get_ratings_report(TEXT, INTEGER);
