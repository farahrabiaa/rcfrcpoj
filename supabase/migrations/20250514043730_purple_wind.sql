/*
  # Vendor Categories Relationship Management

  1. New Functions
    - `link_vendor_to_category`: Links a vendor to a category
    - `unlink_vendor_from_category`: Removes a vendor-category link
    - `get_vendor_categories`: Gets all categories for a vendor
    - `get_vendors_by_category`: Gets all vendors in a category
    - `link_vendor_to_categories`: Links a vendor to multiple categories
    - `get_categories_with_vendor_counts`: Gets all categories with vendor counts
