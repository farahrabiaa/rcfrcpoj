/*
  # Fix vendor categories relationship

  1. New Tables
    - No new tables are created in this migration
  
  2. Changes
    - Adds missing RLS policies to vendor_categories table
    - Creates functions to manage vendor category relationships
    - Ensures proper linking between vendors and categories
  
  3. Security
    - Enables RLS on vendor_categories if not already enabled
