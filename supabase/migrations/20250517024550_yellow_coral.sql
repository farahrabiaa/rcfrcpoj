/*
  # Fix waiting list functionality

  1. New Functions
    - `add_order_to_waiting_list`: Properly adds orders to the driver waiting list
    - `get_waiting_list_orders`: Retrieves orders in the waiting list
  ...
  3. Performance
    - Add indexes for faster queries on driver_waiting_list table
*/
