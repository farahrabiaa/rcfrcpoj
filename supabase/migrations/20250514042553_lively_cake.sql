/*
  # Coupons and Order Coupons Schema

  1. New Tables
    - `coupons` - Stores coupon information including code, discount type, value, etc.
  ...
  3. Functions
    - `validate_coupon` - Validates if a coupon is valid for use
    - `apply_coupon_to_order` - Applies a coupon to an order and calculates discount
