...
export default function OrderProcessing({ order, onClose, onStatusUpdate, isModal = false }) {
  ...
  return (
    <div className="bg-white rounded-lg p-6 relative z-50 max-w-3xl max-h-[90vh] overflow-y-auto shadow-2xl" onClick={(e) => e.stopPropagation()}>
      ...
      {!user ? (
        ...
        <>
          ...
          {/* تعيين سائق أو إضافة لقائمة الانتظار */}
          <div className="border rounded-lg p-4 mb-6">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={!user || addingToWaitingList || ((assignmentType === 'specific' && !selectedDriver) || orderStatus === 'delivering')}
                className={`w-full text-white py-2 rounded-md transition-colors ${
                  !user || addingToWaitingList || ((assignmentType === 'specific' && !selectedDriver) || orderStatus === 'delivering')
          ...
          <div className="border rounded-lg p-4 mb-6">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={!user || updatingStatus}
                className={`w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 transition-colors ${
                  !user || updatingStatus ? 'opacity-70 cursor-not-allowed' : ''
                }`}
              >
