...
export default function DirectDriverCreation() {
    ...
    try {
      ...
      const { data, error } = await supabase
        ...
        .insert([{
          ...
          // تخزين مناطق العمل كبيانات JSON
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold">إضافة سائق مباشرة</h2>
      ...
      <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg">
        ...
        <ul className="list-disc list-inside space-y-2 text-blue-700">
          <li>هذه الطريقة تقوم بإنشاء سائق جديد مباشرة بدون إنشاء حساب مستخدم في نظام المصادقة.</li>
          <li>يتم إنشاء معرف مستخدم عشوائي (UUID) وربطه بالسائق.</li>
          <li>يتم حفظ بيانات السائق في التخزين المحلي مؤقتًا حتى يتم ربطه بقاعدة البيانات.</li>
          <li>لا يمكن للسائق تسجيل الدخول باستخدام هذه الطريقة، ولكن يمكن إدارته من لوحة التحكم.</li>
