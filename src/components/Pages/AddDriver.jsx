...
export default function AddDriver() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // إنشاء اسم مستخدم من رقم الهاتف إذا لم يكن موجودًا
      const username = formData.phone.replace(/\s+/g, '');
      ...
      if (userError) {
        ...
        toast.error('فشل في إنشاء حساب المستخدم: ' + userError.message);
        setLoading(false);
        return;
      }
      ...
      if (driverError) {
        ...
        toast.error('فشل في إنشاء بيانات السائق: ' + driverError.message);
        setLoading(false);
        return;
      }
  ...
  // الدالة الأصلية للمحاكاة (تم استبدالها بالتنفيذ الفعلي)
